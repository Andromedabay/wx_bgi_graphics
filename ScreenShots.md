...
![BGI API coverage](images/screenshot_camera_demo.png)
...
![Keyboard queue demo](images/screenshot_keyboard_queue.png)
...
![cam_left fixed 2D ortho view](images/screenshot_cam_left_2d.png)
...
![cam2d interactive 2D view](images/screenshot_cam2d_interactive.png)
...
[![cam3d 3D perspective orbit](images/screenshot_cam3d_persp.png)](images/screenshot_cam3d_persp.png)

A full perspective camera (`fovY = 60°`) orbiting the scene using arrow keys
...
> Full 1440 × 480 window

![3-panel composite](images/screenshot_camera_demo_3panel.png)
